...
from ...models.generate_user_totp_secret_body import GenerateUserTotpSecretBody
from ...models.generate_user_totp_secret_response_200 import GenerateUserTotpSecretResponse200
from ...types import Response


def _get_kwargs(
    *,
    body: GenerateUserTotpSecretBody,
) -> dict[str, Any]:
...
def sync(
    *,
    ...
    Returns:
        Union[Any, GenerateUserTotpSecretResponse200]
    """
