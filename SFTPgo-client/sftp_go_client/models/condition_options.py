...
from ..models.condition_options_provider_objects_item import ConditionOptionsProviderObjectsItem
...
class ConditionOptions:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for provider_objects_item_data in _provider_objects or []:
            provider_objects_item = ConditionOptionsProviderObjectsItem(provider_objects_item_data)
