...
T = TypeVar("T", bound="CreateUserFilesBody")


@_attrs_define
class CreateUserFilesBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        create_user_files_body = cls(
            filenames=filenames,
        )

        create_user_files_body.additional_properties = d
        return create_user_files_body
