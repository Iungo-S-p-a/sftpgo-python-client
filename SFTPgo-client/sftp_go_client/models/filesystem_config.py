...
if TYPE_CHECKING:
    ...
    from ..models.os_fs_config import OSFsConfig
...
class FilesystemConfig:
    ...
    Attributes:
        provider (Union[Unset, FsProviders]): Filesystem providers:
              ...
              * `5` - SFTP
              * `6` - HTTP filesystem
        osconfig (Union[Unset, OSFsConfig]):
    ...
    osconfig: Union[Unset, "OSFsConfig"] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        osconfig: Union[Unset, dict[str, Any]] = UNSET
        if not isinstance(self.osconfig, Unset):
            osconfig = self.osconfig.to_dict()
        ...
        if osconfig is not UNSET:
            field_dict["osconfig"] = osconfig
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        _osconfig = d.pop("osconfig", UNSET)
        osconfig: Union[Unset, OSFsConfig]
        if isinstance(_osconfig, Unset):
            osconfig = UNSET
        else:
            osconfig = OSFsConfig.from_dict(_osconfig)
