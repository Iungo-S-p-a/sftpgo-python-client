...
from ..models.ftpd_binding_active_connections_security import FTPDBindingActiveConnectionsSecurity
from ..models.ftpd_binding_ignore_ascii_transfer_type import FTPDBindingIgnoreAsciiTransferType
from ..models.ftpd_binding_passive_connections_security import FTPDBindingPassiveConnectionsSecurity
...
class FTPDBinding:
    ...
    Attributes:
        ...
        min_tls_version (Union[Unset, TLSVersions]): TLS version:
              * `12` - TLS 1.2
              * `13` - TLS 1.3
        force_passive_ip (Union[Unset, str]): External IP address for passive connections
        ...
        active_connections_security (Union[Unset, FTPDBindingActiveConnectionsSecurity]): Active connections security:
              * `0` - require matching peer IP addresses of control and data connection
              * `1` - disable any checks
        ignore_ascii_transfer_type (Union[Unset, FTPDBindingIgnoreAsciiTransferType]): Ignore client requests to perform
            ASCII translations:
    ...
    passive_connections_security: Union[Unset, FTPDBindingPassiveConnectionsSecurity] = UNSET
    active_connections_security: Union[Unset, FTPDBindingActiveConnectionsSecurity] = UNSET
    ignore_ascii_transfer_type: Union[Unset, FTPDBindingIgnoreAsciiTransferType] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        ignore_ascii_transfer_type: Union[Unset, int] = UNSET
        if not isinstance(self.ignore_ascii_transfer_type, Unset):
            ignore_ascii_transfer_type = self.ignore_ascii_transfer_type.value
        ...
        if ignore_ascii_transfer_type is not UNSET:
            field_dict["ignore_ascii_transfer_type"] = ignore_ascii_transfer_type
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for passive_ip_overrides_item_data in _passive_ip_overrides or []:
            passive_ip_overrides_item = PassiveIPOverride.from_dict(passive_ip_overrides_item_data)
        ...
        passive_connections_security: Union[Unset, FTPDBindingPassiveConnectionsSecurity]
        if isinstance(_passive_connections_security, Unset):
            passive_connections_security = UNSET
        else:
            passive_connections_security = FTPDBindingPassiveConnectionsSecurity(_passive_connections_security)
        ...
        if isinstance(_active_connections_security, Unset):
            ...
            active_connections_security = FTPDBindingActiveConnectionsSecurity(_active_connections_security)

        _ignore_ascii_transfer_type = d.pop("ignore_ascii_transfer_type", UNSET)
        ignore_ascii_transfer_type: Union[Unset, FTPDBindingIgnoreAsciiTransferType]
        if isinstance(_ignore_ascii_transfer_type, Unset):
            ignore_ascii_transfer_type = UNSET
        else:
            ignore_ascii_transfer_type = FTPDBindingIgnoreAsciiTransferType(_ignore_ascii_transfer_type)
        ...
        ftpd_binding = cls(
            ...
            ignore_ascii_transfer_type=ignore_ascii_transfer_type,
            debug=debug,
        )
