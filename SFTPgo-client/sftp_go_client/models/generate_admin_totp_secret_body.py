...
T = TypeVar("T", bound="GenerateAdminTotpSecretBody")


@_attrs_define
class GenerateAdminTotpSecretBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        generate_admin_totp_secret_body = cls(
            config_name=config_name,
        )

        generate_admin_totp_secret_body.additional_properties = d
        return generate_admin_totp_secret_body
