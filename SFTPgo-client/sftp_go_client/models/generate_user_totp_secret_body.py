...
T = TypeVar("T", bound="GenerateUserTotpSecretBody")


@_attrs_define
class GenerateUserTotpSecretBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        generate_user_totp_secret_body = cls(
            config_name=config_name,
        )

        generate_user_totp_secret_body.additional_properties = d
        return generate_user_totp_secret_body
