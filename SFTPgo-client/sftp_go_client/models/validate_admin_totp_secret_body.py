...
T = TypeVar("T", bound="ValidateAdminTotpSecretBody")


@_attrs_define
class ValidateAdminTotpSecretBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        validate_admin_totp_secret_body = cls(
            config_name=config_name,
            passcode=passcode,
            secret=secret,
        )

        validate_admin_totp_secret_body.additional_properties = d
        return validate_admin_totp_secret_body
